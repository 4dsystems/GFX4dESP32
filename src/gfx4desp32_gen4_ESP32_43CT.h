...
class gfx4desp32_gen4_ESP32_43CT : public gfx4desp32_rgb_panel_t {
private:
    const char* TAG = "gfx4desp32_gen4_ESP32_43CT";
...
public:
    gfx4desp32_gen4_ESP32_43CT();
    ~gfx4desp32_gen4_ESP32_43CT();
};

#endif  // __GFX4D_43CT__