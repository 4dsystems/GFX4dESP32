#ifndef __GEN4_32CT__
#define __GEN4_32CT__
...
class gfx4desp32_gen4_ESP32_32CT : public gfx4desp32_spi_panel_t {
private:
    const char* TAG = "gfx4desp32_gen4_ESP32_32CT";
