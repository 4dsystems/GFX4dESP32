#ifndef __GFX4D_GEN4_50CT__
#define __GFX4D_GEN4_50CT__

#define DISPLAY_TOUCH_TYPE          DISP_TOUCH_CTP
#define GEN4_50CT_PIXEL_CLOCK_HZ    (13 * 1000 * 1000)
#define GEN4_50CT_SWAP_TOUCHY       1
...
class gfx4desp32_gen4_ESP32_50CT : public gfx4desp32_rgb_panel_t {
private:
    const char* TAG = "gfx4desp32_gen4_ESP32_50CT";
    ...
    esp_lcd_rgb_panel_config_t panel_config = {
        ...
        .timings = {
            .pclk_hz = GEN4_50CT_PIXEL_CLOCK_HZ,
...
public:
    gfx4desp32_gen4_ESP32_50CT();
    ~gfx4desp32_gen4_ESP32_50CT();
};

#endif  // __GFX4D_GEN4_50CT__