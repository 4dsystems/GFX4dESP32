#ifndef __GFX4D_GEN4_50__
#define __GFX4D_GEN4_50__

#define DISPLAY_TOUCH_TYPE          DISP_TOUCH_NONE
#define GEN4_50_PIXEL_CLOCK_HZ      (20 * 1000 * 1000)
#define GEN4_50_SWAP_TOUCHY         1 // ignored
...
class gfx4desp32_gen4_ESP32_50 : public gfx4desp32_rgb_panel {
private:
    const char* TAG = "gfx4desp32_gen4_ESP32_50";
    ...
    .clk_src = LCD_CLK_SRC_PLL160M,//  LCD_CLK_SRC_DEFAULT,
        .timings = {
            .pclk_hz = GEN4_50_PIXEL_CLOCK_HZ,
...
public:
    gfx4desp32_gen4_ESP32_50();
    ~gfx4desp32_gen4_ESP32_50();
};

#endif  // __GFX4D_GEN4_50__