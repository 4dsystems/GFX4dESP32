#ifndef __GFX4D_90CT__
#define __GFX4D_90CT__

#define DISPLAY_TOUCH_TYPE DISP_TOUCH_CTP
#define ESP32_90CT_PIXEL_CLOCK_HZ (18 * 1000 * 1000) // was 14, 20 min in datasheet
#define ESP32_90CT_SWAP_TOUCHY 0
...
class gfx4desp32_ESP32_90CT : public gfx4desp32_rgb_panel_t
{
private:
    const char* TAG = "gfx4desp32_ESP32_90CT";
    ...
    esp_lcd_rgb_panel_config_t panel_config = {
        ...
        .timings = {
            .pclk_hz = ESP32_90CT_PIXEL_CLOCK_HZ,
...
public:
    gfx4desp32_ESP32_90CT();
    ~gfx4desp32_ESP32_90CT();
};

#endif // __GFX4D_90CT__