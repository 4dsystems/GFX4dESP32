#ifndef __GEN4_32CT_CLB__
#define __GEN4_32CT_CLB__
...
class gfx4desp32_gen4_ESP32_32CT_CLB : public gfx4desp32_spi_panel_t {
private:
    const char* TAG = "gfx4desp32_gen4_ESP32_32CT_CLB";
...
#include "gfx4desp32_gen4_ESP32_32_Init.h"
    ...
    gfx4desp32_gen4_ESP32_32CT_CLB();
    ~gfx4desp32_gen4_ESP32_32CT_CLB();

    virtual uint8_t* SelectINIT(bool sel) override;
};

#endif  // __GEN4_32CT_CLB__